...
const HelmetContainer: React.FC<Props> = ({ seoData, ogData }) => {
  ...
  return (
    <Helmet>
      ...
      <meta property="og:title" content={ogData?.ogTitle || ogSystemData?.title} />
      <meta property="og:description" content={ogData?.ogDescription || ogSystemData?.description} />
      <meta property="og:image" content={`${BASE_URL}${ogData?.ogImage || ogSystemData?.image}`} />
      <meta property="og:type" content={ogData?.ogType || ogSystemData?.type} />
